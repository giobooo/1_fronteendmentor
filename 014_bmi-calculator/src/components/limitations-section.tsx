import "../styles/_lim-section.scss";
...
function Limitations(){
    return(
        <section className="lim-section">
            ...
            <div className="lim-section__text">
                <h2>Limitations of BMI</h2>
                <span>Although BMI is often a practical indicator of healthy weight, it is not suited for every person. Specific groups should carefully consider their BMI outcomes, and in certain cases, the measurement may not be beneficial to use.</span>
            </div>
            <div className="lim-grid">
                <div className="lim-gender">
                    ...
                    <h3>Gender</h3>
                    <span>The development and body fat composition of girls and boys vary with age. Consequently, a child's age and gender are considered when evaluating their BMI.</span>
                </div>
                <div className="lim-age">
                    ...
                    <h3>Age</h3>
                    <span>In aging individuals, increased body fat and muscle loss may cause BMI to underestimate body fat content.</span>
                </div>
                <div className="lim-muscle">
                    ...
                    <h3>Muscle</h3>
                    <span>BMI may misclassify muscular individuals as overweight or obese, as it doesn't differentiate muscle from fat.</span>
                </div>
                <div className="lim-preg">
                    ...
                    <h3>Pregnancy</h3>
                    <span>Expectant mothers experience weight gain due to their growing baby. Maintaining a healthy pre-pregnancy BMI is advisable to minimise health risks for both mother and child.</span>
                </div>
                <div className="lim-race">
                    ...
                    <h3>Race</h3>
                    <span>Certain health concerns may affect individuals of some Black and Asian origins at lower BMIs than others. To learn more, it is advised to discuss this with your GP or practice nurse.</span>
                </div>
            </div>
        </section>
    )
