import "../styles/_tips-section.scss";

function TipsSection()
{
    return(
        <section className="tips-section">
            <div className="tips-section__bg"></div>
            <div className="tips-section__container">
                <div className="tips-section__tip">
                    ...
                    <span>Healthy eating promotes weight control, disease prevention, better digestion, immunity, mental clarity, and mood.</span>
                </div>
                <div className="tips-section__tip">
                    ...
                    <span>Exercise improves fitness, aids weight control, elevates mood, and reduces disease risk, fostering wellness and longevity.</span>
                </div>
                <div className="tips-section__tip">
                    ...
                    <span>Sleep enhances mental clarity, emotional stability, and physical wellness, promoting overall restoration and rejuvenation.</span>
                </div>
            </div>
        </section>
    )
